      ...
      <div class="col-md-12">
        <div class="row">
            <div class="col-md-6 offset-md-1">
                <h1><?= $movie->title ?></h1>
                <p class="page-description">Altere os dados do filme abaixo:</p>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="title" name="title" placeholder="Digite o titulo do filme que deseja adicionar:" value="<?= $movie->title ?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="trailer" value="<?= $movie->trailer ?>">Trailer: </label>
